...
# setup widoco
echo "Widoco setup ..."
cd $PLAYGROUND;mkdir widoco;cd widoco; wget --progress=bar:force https://github.com/dgarijo/Widoco/releases/download/v1.4.17/java-17-widoco-1.4.17-jar-with-dependencies.jar ; mv *.jar widoco.jar ; chmod 777 widoco*
