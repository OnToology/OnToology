...
def get_repo_dict(repo):
  ...
  "source": get_parent_dict(repo)
    ...
    #     "network_count": 0,
    #     "license": get_license_dict(),
    #     "organization": get_organization_dict(user),
    #     "parent":  get_parent_dict(repo),
    #     "source": get_parent_dict(repo), # source is the same as parent from the example in the API website
    # }
